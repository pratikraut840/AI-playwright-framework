...
export class AdminUserManagementPage {
  ...
  public async gotoAddUser(baseUrl: string): Promise<void> {
  ...
  public async searchByUsername(username: string): Promise<void> {
  ...
  public async searchByStatus(status: UserStatus): Promise<void> {
  ...
  public async getRecordsCountText(): Promise<string> {
  ...
  public async getStatusCellTexts(): Promise<string[]> {
  ...
  public async fillEmployeeName(namePrefix: string): Promise<void> {
  ...
  public async fillConfirmPasswordField(password: string): Promise<void> {
  ...
  public async getPasswordStrengthText(): Promise<string> {
